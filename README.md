...
Built with React Native, Google Maps for directions, Stripe for payments, serverless Postgres for database, and TailwindCSS, Uber Clone is a full-stack mobile app for ordering transportation digitally.
...
👉 The app features seamless onboarding with email-password authentication, email verification, and Google oAuth. It includes secure role-based authorization and a home screen with live location tracking and Google Maps integration. Users can search rides using Google Places Autocomplete, find and select cars on the map, view detailed ride information, and pay securely via Stripe. After payment, rides are booked instantly. Additional features include a profile manager, ride history, and recent rides list, all optimized for Android and iOS devices.
...
Replace the placeholders with your actual Clerk, Stripe, NeonDB, Google Maps, andgeoapify credentials: [Clerk](https://clerk.com/), [Stripe](https://stripe.com/in), [NeonDB](https://neon.tech/), [Google Maps](https://console.cloud.google.com/), [geoapify (https://www.geoapify.com/)
